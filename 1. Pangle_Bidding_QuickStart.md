...
Currently (2021 February), Pangle has official Advanced Bidding with Mopub, Ironsource, and MAX, and all of our partners have opened Advanced Bidding to publishers by default.
...
After you have opened Advanced Bidding on Pangle side, you can start your Advanced Bidding test.
In this article, we're going to introduce how to set up an Advanced Bidding placement.
